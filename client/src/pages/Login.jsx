    ...
    <MainLayout>
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-16">
        <GlowCard className="w-full max-w-md p-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Log in to continue analyzing your resumes.</p>
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            Don't have an account? <Link to="/signup" className="text-accent-orange-light font-medium hover:underline">Sign up free</Link>
          </p>
        </GlowCard>
      </div>
    </MainLayout>
